...
# TOGGLE FLOATING LAYOUT
    # mod+left-mouse moves the floating window
    # mod+right-mouse resizes the floating windows
...
group_labels = ["1 ", "2 ", "", "4 ", "5 ", "6 ", "7 ", "8 ", "9 ", "",]
# group_labels = ["", "", "", "", "", "", "", "", "", "",]
#group_labels = ["", "", "", "", "",]
#group_labels = ["Web", "Edit/chat", "Image", "Gimp", "Meld", "Video", "Vb", "Files", "Mail", "Music",]

group_layouts = ["monadtall", "monadtall", "max", "monadtall", "monadtall", "monadtall", "monadtall", "monadtall", "treetab", "floating",]
...
def init_layout_theme():
    return {"margin": 2,
            "border_width": 1,
            "border_focus": highCol,
            "border_normal": darkCol,
            "grow_amount": 2,
            }
...
layouts = [
        layout.MonadTall(change_ratio=0.015, change_size=2, **layout_theme),
...
def init_colors():
    return [["#2F343F", "#2F343F"], # color 0
            ...
            ["#555555", "#555555"], # color 3
            ["#888888", "#888888"], # color 4
            ["#ffffff", "#ffffff"], # color 5
            ["#ff0000", "#ff0000"], # color 6
            ["#dddd00", "#dddd00"], # color 7
            ["#000000", "#000000"], # color 8
            ["#333333", "#333333"], # color 9
            ["#6790eb", "#6790eb"], # color 10
            ["#ffffff", "#ffffff"]]# color 11
...
def init_screens():
    return [
            Screen(top=bar.Bar(widgets=init_widgets_screen1(), size=30, opacity=0.85, background= "000000")),
            Screen(),
            ]
